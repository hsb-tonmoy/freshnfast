...
<main class="flex h-screen">
	<div class="sidebar flex flex-col w-[20%] px-12">
		<div id="logo" class="self-center">
			<a href="/">
				<img
					class={`transition-all ease-in-out duration-500 w-16 h-16 md:w-20 md:h-20 lg:w-32 lg:h-32 mt-8`}
					src="/images/logo.png"
					alt="FreshNFast"
				/>
			</a>
		...
		<div class="flex flex-col mt-20">
			<span class="font-semibold text-3xl text-lightGreen">Thank you for your order!</span>
		...
		<div class="receipt flex flex-col mt-20">
